...
import sys
import os
sys.path.append(os.path.join(personal_code_path, 'Infinity'))
...
def add_common_arguments(parser):
    ...
    vae_path=os.path.join(models_dir,'FoundationVision/Infinity/infinity_vae_d32reg.pth')
    ...
    parser.add_argument('--text_encoder_ckpt', type=str, default=text_encoder_ckpt)
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--prompt', type=str, default='A perfectly symmetrical snowflake on a dark background, macro photography, intricate fractal details.')
    parser.add_argument('--prompt', type=str, default='A beautiful landscape painting of mountains during sunset, with vibrant colors and intricate details, in the style of a classic oil painting.')

    parser.add_argument('--save_file', type=str, default='./outputs/idea_tmp.jpg')
